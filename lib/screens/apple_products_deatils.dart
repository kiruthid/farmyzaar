...
class AppleProductsPage extends StatefulWidget {
  const AppleProductsPage({super.key});

  @override
  State<AppleProductsPage> createState() => _AppleProductsPageState();
}

class _AppleProductsPageState extends State<AppleProductsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const CustomHeader(title: 'Details'),
          Expanded(
